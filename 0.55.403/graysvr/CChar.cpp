...
LPCTSTR const CChar::sm_szTrigName[CTRIG_QTY+1] =	// static
{
	...
	"@PartyCreate",			//+(PLAYER only) party is about to be created (first member added)
	"@PartyInvite",			//+(PLAYER only) i was invited to a party? or am i inviting someone? <argn1> decides
	"@PartyJoin",			//+(PLAYER only) i decided to join a party? or is someone joining my party? <argn1> decides
	"@PartyLeave",			//+(PLAYER only) i am leaving the party (would return 1 work here?)
