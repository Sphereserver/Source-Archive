...
{
	VERFILE_MAP			= 0x00,	// "map0.mul" = Array of base Terrain data
...
// Map 0
#define UO_SIZE_X			0x1800	// 768*UO_BLOCK_SIZE = 6144 = Total Size In meters
#define UO_SIZE_X_REAL		0x1400	// 640*UO_BLOCK_SIZE = 5120 = The actual world is only this big
#define UO_SIZE_Y			0x1000  // 512*UO_BLOCK_SIZE = 4096 = Total height
