...
LPCTSTR g_szServerDescription =
	GRAY_TITLE " Version %s " // Version " GRAY_VERSION " "
#ifdef _WIN32
	"[WIN32]"
#else
#ifdef _BSD
...
{
	// We allocate an additional 4 bytes for
	// storing the size of the memory block
	// This is a very very bad habit, but we use it for profiling our
	// memory usage
...
void _cdecl operator delete( void *ptr )
{
	...
	if( ptr )
	{
		...
		// with our overrideen new operator. That allows us to to track our
		// memory usage.
