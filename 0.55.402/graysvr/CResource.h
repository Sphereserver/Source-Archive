...
enum EF_TYPE
{
	...
	EF_CanSeeLOS				= 0x0000004,
	EF_Scripts_Ret_Strings		= 0x0000008,
	EF_New_Triggers				= 0x0000010,
	EF_New_Maps					= 0x0000020,
	EF_Scripts_Parse_Verbs		= 0x0000040,
	EF_Intrinsic_Locals			= 0x0000080,
	EF_Allow_Override			= 0x0000100,
	EF_Item_Strict_Comparison	= 0x0000200,
	EF_No_Pause_Packet			= 0x0000400,
	EF_Unused800				= 0x0000800,
	EF_WalkCheck				= 0x0001000,
	EF_AgeOfShadows				= 0x0002000,
	EF_DiagonalLOSCheck			= 0x0004000,
...
public:
	...
	CValueCurveDef	m_Costs;	// training costs, in percentage
...
public:
	...
	bool	IsSetEF( EF_TYPE ef );
	bool	IsSetOF( OF_TYPE of );
	bool	IsSetSpecific();
