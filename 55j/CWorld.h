...
#define FELUCCA_FULL_BRIGHTNESS 6 // light units LIGHT_BRIGHT
	...
	void GetHeightPoint( const CPointMap & pt, CGrayMapBlockState & block, const CRegionBase * pRegion = NULL );
	signed char GetHeightPoint( const CPointBase & pt, WORD & wBlockFlags, const CRegionBase * pRegion = NULL ); // Height of player who walked to X/Y/OLDZ
	...
	CItem * CheckNaturalResource( const CPointMap & pt, IT_TYPE Type, bool fTest = true );
