...
public:
	...
	void addGumpDialog( CLIMODE_TYPE mode, const CGString * sControls, int iControls, const CGString * psText, int iTexts, int x, int y, CObjBase * pObj = NULL );
	...
	virtual bool IsAnsi() const
	{
		...
		return( m_ConnectType == CONNECT_TELNET );
	}
