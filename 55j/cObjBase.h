...
public:
	...
	TRIGRET_TYPE OnHearTrigger( CResourceLock & s, LPCTSTR pCmd, CChar * pSrc = NULL );
...
public:
	...
	static CItem * CreateHeader( TCHAR * pArg, CObjBase * pCont = NULL, bool fDupeCheck = false );
...
public:
	CStoneMember( CItemStone * pStone, CGrayUID uid, STONEPRIV_TYPE iType, LPCTSTR pTitle = "", CGrayUID loyaluidLink = 0, bool fArg1 = false, bool fArg2 = false );
...
public:
	...
	DWORD m_dwPlot1;	// script triggers the get item interaction events .
	DWORD m_dwPlot2;	// non-triggers.
...
{
	// XTRIG_UNKNOWN	= some named trigger not on this list.
	CTRIG_Click=1,			// I got clicked on by someone.
...
#define SKILL_VARIANCE 100		// Difficulty modifier for determining success. 10.0 %
	...
	short m_Stat[STAT_QTY];		// karma is signed. (stats should be able to go temporariliy negative !)
...
public:
	...
	bool Skill_MakeItem( ITEMID_TYPE id, CGrayUID uidTarg, SKTRIG_TYPE stage );
