// CSocket.h
    ...
    public:
    	...
    	SOCKET Accept( struct sockaddr_in * pSockAddrIn ) const
    	{
    		...
    		return( accept( m_hSocket, (struct sockaddr*) pSockAddrIn, &len ));
    	}
    	...
    	int GetSockName( struct sockaddr_in * pSockAddrIn ) const
    	{
    		...
    		return( getsockname( m_hSocket, (struct sockaddr *) pSockAddrIn, &len ));
    	}
    	...
    	int GetPeerName( struct sockaddr_in * pSockAddrIn ) const
    	{
    		...
    		// RETURN: 0 = success
    		int len = sizeof( *pSockAddrIn );
    		return( getpeername( m_hSocket, (struct sockaddr *) pSockAddrIn, &len ));
    	}
    	...
    	{
    		return( getsockopt( m_hSocket, nLevel, nOptionName, (char FAR *) optval, poptlen ));
    	}
