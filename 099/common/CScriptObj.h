    ...
    private:
    	// State stack !
    	CScriptStackFrame m_StateStack;
    ...
    private:
    	TRIGRET_TYPE OnTriggerForLoop( CScript &s, int iType, CTextConsole * pSrc, CScriptTriggerArgs * pArgs );
    public:
    	...
    	TRIGRET_TYPE OnTriggerRun( CScript &s, TRIGRUN_TYPE trigger, CTextConsole * pSrc = NULL, CScriptTriggerArgs * pArgs = NULL );
    ...
    public:
    	...
    	CScriptObj * m_pO1;		// these can go out of date ! get deleted etc.
    	// "ARGO2" = object 2
    	// CScriptObj * m_pO2;
