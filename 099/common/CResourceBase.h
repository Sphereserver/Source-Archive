    ...
    enum RES_TYPE	// all the script resource blocks we know how to deal with !
    {
    	...
    	RES_PLOTITEM,		// (Phase this out in favor of better @trigger TEVENT= and EVENT= support.)
    	RES_QUEST,
    ...
    public:
    	...
    	{
    		DWORD dwVal = m_dwInternalVal >> RES_TYPE_SHIFT;
    		dwVal &= RES_TYPE_MASK;
    ...
    #define RES_GET_INDEX(dw)	((dw)&RES_INDEX_MASK)
    	...
    	{
    		return(m_dwInternalVal & RES_INDEX_MASK);
    	}
    ...
    public:
    	...
    	void WriteKeys( TCHAR * pszArgs ) const;
    	void WriteNames( TCHAR * pszArgs ) const;
    ...
    public:
    	int CompareKey( RESOURCE_ID_BASE rid, CResourceDef * pBase ) const
    	{
    ...
    class CObNameSortArray : public CGObSortArray< CScriptObj*, LPCTSTR >
    {
    	...
    	int CompareKey( LPCTSTR pszID, CScriptObj* pObj ) const
    	{
    		ASSERT( pszID );
    		ASSERT( pObj );
    ...
    {
    protected:
    	static LPCTSTR const sm_szResourceBlocks;
