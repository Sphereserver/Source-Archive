    ...
    void CCharBase::SetFoodType( LPCTSTR pszFood )
    {
        ...
        {
                if ( m_MaxFood < m_FoodType.GetResQty())
                        m_MaxFood = m_FoodType.GetResQty();
        }
    }
    ...
    enum CBC_TYPE
    {
        ...
        CBC_AVERSIONS,
        CBC_BLOODCOLOR,
        CBC_DEF,                        /// get rid of this in the future.
        CBC_DESIRES,
        CBC_DEX,
        CBC_DISPID,
        CBC_FOODTYPE,
    ...
    LPCTSTR const CCharBase::sm_szLoadKeys =
    {
        "ANIM",
        "ARMOR",
        "AVERSIONS",
        "BLOODCOLOR",
        "DEF",                  /// get rid of this in the future.
        "DESIRES",
        "DEX",
        "DISPID",
        "FOODTYPE",
