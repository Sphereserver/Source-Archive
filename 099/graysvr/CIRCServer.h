/************************************************************************
    ...
    */
    ...
    class CIRCTools
    {
        static char sm_scratch_buffer;
        static char sm_szNumericBuffer;
    ...
    public:
        ...
        static const char sm_cConvert2y;
        // To convert a string to an int
        static const BYTE sm_ucConvert2n;
        static LPCTSTR const sm_CmdTbl;
        static const char sm_atoi_tab;
    public:
    ...
    public:
        ...
        CIRCNumNick m_NumNicks; // Anyway to make this dynamic?
    public:
        ...
        {
                //  = server ID,  &  = index into 's array of nicks
                unsigned char ucNN1 = (unsigned char)szNumNick;
                unsigned char ucNN2 = (unsigned char)szNumNick;
                int i1 = CIRCTools::sm_ucConvert2n;
                int i2 = CIRCTools::sm_ucConvert2n;
    ...
    {
    public:
        char m_szUser;          // The USER they used
        char m_szHost;          // The hostname they had
        char m_szRealName;      // Their "real name"
    ...
    {
    public:
        char m_szHostMask;      // Host mask to send this MOTD to
        char m_szPath;          // Full path name to this MOTD
    };
    
    class CIRCLocalServer       : public CIRCMyNumNicks
    {
    private:
        friend CIRCMachine;                             // Makes life easier this way
        ...
        time_t m_TSoffset;
    public:
        static DWORD m_dwUserModes;
        char m_szSendUModeBuffer;
        char m_szSendBuffer;
        char m_szNick;                  // I guess these are more like an ID, only one char
    ...
    public:
        ...
        int MakeNumNick( CIRCNumNick* pNumNick, char* szNumNick )
        {
                ...
                //  = my ID on the network,   &  = the client's slot in the numnick array
                assert( pNumNick );
                ...
                else
                {
                        ...
                        {
                                i0 = pLRClient->m_pServer->m_szNick;
                        }
                }
                char i1 = iSlot >> NUMNICKLOG;
                char i2 = iSlot - ( i1 << NUMNICKLOG );
                sprintf( szNumNick, "%c%c%c", i0, CIRCTools::sm_cConvert2y, CIRCTools::sm_cConvert2y );
                return iSlot;
        }
    };
