    ...
    struct CPathNode
    {
        ...
        int m_g;
        CPathNode *m_pParent;
        CPathNode *m_pChild; // a node may have up to 8 children.
    ...
    public:
        ...
        void AddChild( CPathNode* pOld )
        {
                ...
                {
                        if ( m_pChild == NULL ) // Add Old to the list of pBestNode's Children (or Successors).
                        {
                                m_pChild = pOld;
                                return;
                        }
    ...
    public:
        ...
        {
                //  NOTE:
                //   if m_piTileMap==0 it means free so just !(not) it.
                //  RETURN:
...
agating
    ...
    void CChar::NPC_FindPath( const CPointMap & pt, int iMaxDist, DWORD dwImmunities )
    {
