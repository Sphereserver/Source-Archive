    ...
    int CResource::Calc_MaxCarryWeight( const CChar * pChar ) const
    {
        ...
        return( pChar->Stat_Get(STAT_STR) * 4 * WEIGHT_UNITS + ( 30 * WEIGHT_UNITS ) );
    }
    ...
    int CResource::Calc_WalkThroughChar( CChar * pCharMove, CChar * pCharObstacle )
    {
        ...
        int iStamReq = Calc_GetLog2( pCharObstacle->Stat_Get(STAT_STR)) + 1;
    ...
    int CResource::Calc_CombatAttackSpeed( CChar * pChar, CItem * pWeapon )
    {
        ...
        int iWaitTime = IMULDIV( 100 - pChar->Stat_Get(STAT_DEX), 40, 100 );
    ...
    int CResource::Calc_CharDamageTake( CChar * pChar, CItem * pWeapon, CChar * pCharAttacker, int iDamage, DAMAGE_TYPE DamageTy
pe, BODYPART_TYPE LocationHit )
    {
    ...
    int CResource::Calc_ItemDamageTake( CItem * pItem, CItem * pWeapon, CChar * pCharAttacker, int iDamage, DAMAGE_TYPE DamageTy
pe, BODYPART_TYPE LocationHit )
    {
        // RETURN:
    ...
    bool CResource::Calc_CrimeSeen( CChar * pCharThief, CChar * pCharViewer, SKILL_TYPE SkillToSee, bool fBonus )
    {
        ...
        int iChanceToSee = ( pCharViewer->Stat_Get(STAT_DEX) + pCharViewer->Stat_Get(STAT_INT)) * 50;
