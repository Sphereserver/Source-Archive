    ...
    LPCTSTR const CSector::sm_szLoadKeys =
    {
        "COLDCHANCE",
        "COMPLEXITY",
        "ISDARK",
    ...
    LPCTSTR const CSector::sm_szVerbKeys =
    {
        "ALLCLIENTS",
        "DRY",
        "LIGHT",
    ...
    static const BYTE sm_TrammelPhaseBrightness =
    {
        ...
        TRAMMEL_FULL_BRIGHTNESS / 4,    // Crescent Moon
                        ...
                        iTargLight -= sm_TrammelPhaseBrightness;
                }
    ...
    static const BYTE sm_FeluccaPhaseBrightness =
    {
        ...
        FELUCCA_FULL_BRIGHTNESS / 4,    // Crescent Moon
                        ...
                        iTargLight -= sm_FeluccaPhaseBrightness;
                }
        }
